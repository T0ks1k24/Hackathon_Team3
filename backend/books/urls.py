...
from .views import GenreListCreateView, BookListCreateView, BookRetrieveUpdateDestroyView, ImportBooksView, ExportBooksExcelView
...
urlpatterns = [
    ...
    path('export/', ExportBooksExcelView.as_view(), name='export-excel'),
]